...
<script type="text/javascript">
  ...
  if(status=="sucess"){
	  swal("Your data saved suceesfully");
  }	  
  else if(status=="invaildUname")
  {
	  swal("Sorry", "Please Enter a vaild Name", "Error");
	  
  }
  else if(status=="invaildEmail")
  {
   swal("Sorry","Please Enter a username","Error");
  }

  else if(status=="invaildUpwd")
  {
   swal("Sorry"," Please Enter a  Password","Error");
  }
  else if(status=="invaildConfirmPass")
	{
	swal("Sorry","Password do not match" ,"Error");
	}
  else if(status=="invaildUmobi")
	{
	
	
	swal("Sorry","Please Enter a Mobile Number ","Error");
	}
  else if(status=="invaildMobileLength")
	{
